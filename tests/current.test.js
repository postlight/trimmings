describe('current', () => {
  ...
  test('post-load updates', async () => {
    ...
    await expect(page).not.toMatchElement('.current3-embed-container .current3.redact-current')
    await expect(page).toMatchElement('.current3-embed-container .current2.redact-current')
  })
})
